...
public class DatabaseHelper extends SQLiteOpenHelper {
    private static String DATABASE_NAME = "SMSList.db";
    ...
    private static String CREATE_TABLE = "CREATE TABLE " + TABLE_NAME + "(" + ID + " INTEGER PRIMARY KEY AUTOINCREMENT," + SMS + " VARCHAR(1000)," + CATAGORY + " VARCHAR(50)," + FAVOURITE + " VARCHAR(5))";
    ...
    //Insert Data
    public long insertData(String sms, String catagory, String favourite) {
    ...
    //Update Data
    public boolean updateData(String id, String sms, String catagory, String favourite) {
        SQLiteDatabase sqLiteDatabase = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
